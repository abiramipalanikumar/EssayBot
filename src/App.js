...
function App() {
  ...
  return (
    <div className="App">
      ...
      <label style={{ color: "red", fontSize: "18px", textAlign: 'left' }}><b>Enter Your Topic</b></label>
      <input id="inputtext" type="text" style={{ border: "1px solid black", padding: "5px", fontSize: "16px" }} />
